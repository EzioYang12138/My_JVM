...
import cn.yangjian.jvm.instruction.Opcode;
import cn.yangjian.jvm.instruction.arithmetic.arithmetic.*;
import cn.yangjian.jvm.instruction.arithmetic.bitwise.*;
import cn.yangjian.jvm.instruction.arithmetic.logic.Iand;
import cn.yangjian.jvm.instruction.arithmetic.logic.Land;
import cn.yangjian.jvm.instruction.arithmetic.relation.*;
import cn.yangjian.jvm.instruction.arithmetic.unary.Iinc;
import cn.yangjian.jvm.instruction.controltransfer.*;
import cn.yangjian.jvm.instruction.exception.Athrow;
import cn.yangjian.jvm.instruction.loadandstore.constant.*;
import cn.yangjian.jvm.instruction.loadandstore.load.*;
import cn.yangjian.jvm.instruction.loadandstore.store.*;
import cn.yangjian.jvm.instruction.methodinvocation.*;
import cn.yangjian.jvm.instruction.objectcreatemanipulate.*;
import cn.yangjian.jvm.instruction.oprandstack.*;
import cn.yangjian.jvm.instruction.synchronization.MonitorEnter;
import cn.yangjian.jvm.instruction.synchronization.MonitorExit;
import cn.yangjian.jvm.instruction.typeconversion.*;
